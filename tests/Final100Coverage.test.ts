...
describe('Final 100% Coverage Tests', () => {
  describe('LightweightActuator - Final Lines', () => {
    ...
    it('should test all remaining uncovered lines', async () => {
      await actuator.start();
      const port = actuator.getPort();

      // Test all endpoints to cover more lines
      const endpoints = [
        '/actuator/health',
        '/actuator/metrics',
        '/actuator/info',
  ...
  describe('LightweightServer - Final Lines', () => {
    ...
    it('should test remaining uncovered lines', async () => {
  ...
  describe('HealthChecker - Final Lines', () => {
    it('should test remaining uncovered lines', async () => {
      // Test timeout
      const slowCheck = {
        name: 'slow-check',
      ...
      // Test disk space threshold failure - platform specific
      ...
      // On Windows, disk space check returns hardcoded values, so we need to adjust expectations
      if (process.platform === 'win32') {
        // Windows returns 1GB free space, which is less than 1TB threshold, so should be DOWN
        expect(diskHealth.status).toBe('DOWN');
      } else {
        // Unix systems use actual disk space, which should be DOWN with 1TB threshold
        expect(diskHealth.status).toBe('DOWN');
      }
  ...
  describe('ThreadDump - Final Lines', () => {
  ...
  describe('Timeout Utils - Final Lines', () => {
    it('should test remaining uncovered lines', async () => {
  ...
  describe('Logger - Final Lines', () => {
    it('should test remaining uncovered lines', () => {
  ...
  describe('MetricsCollector - Final Lines', () => {
  ...
  describe('InfoCollector - Final Lines', () => {
  ...
  describe('EnvironmentCollector - Final Lines', () => {
